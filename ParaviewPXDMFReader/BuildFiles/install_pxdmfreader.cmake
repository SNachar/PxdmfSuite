...
set(plugin_dir "${TMP_DIR}/PxdmfReaderPlugin-${bundle_suffix}")

file(REMOVE_RECURSE "${plugin_dir}")
file(MAKE_DIRECTORY "${plugin_dir}")

#          "${BINARY_DIR}/${PLUGIN_DIR}/${SHARED_LIBRARY_PREFIX}PXDMFReader${SHARED_LIBRARY_SUFFIX}"
file(COPY "${SOURCE_DIR}/README"
          "${BINARY_DIR}/${SHARED_LIBRARY_PREFIX}PXDMFReader${SHARED_LIBRARY_SUFFIX}"
...
make_plugin_tarball("${TMP_DIR}"
  ...
  "PxdmfReaderPlugin-${bundle_suffix}")
