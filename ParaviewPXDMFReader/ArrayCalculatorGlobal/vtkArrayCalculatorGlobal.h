/*=========================================================================
  ...
  Module:    vtkArrayCalculatorGlobal.h
...
=========================================================================*/
// .NAME vtkArrayCalculatorGlobal - perform mathematical operations on data in field data arrays
// .SECTION Description
// vtkArrayCalculatorGlobal performs operations on vectors or scalars in field
...
#ifndef __vtkArrayCalculatorGlobal_h 
#define __vtkArrayCalculatorGlobal_h
...
class VTK_EXPORT vtkArrayCalculatorGlobal : public vtkDataSetAlgorithm
{
public:
  vtkTypeMacro(vtkArrayCalculatorGlobal,vtkDataSetAlgorithm);
  void PrintSelf(ostream& os, vtkIndent indent);

  static vtkArrayCalculatorGlobal *New();
...
protected:
  ...
  int     ResultArrayType;
private:
  vtkArrayCalculatorGlobal(const vtkArrayCalculatorGlobal&);  // Not implemented.
  void operator=(const vtkArrayCalculatorGlobal&);  // Not implemented.
};
