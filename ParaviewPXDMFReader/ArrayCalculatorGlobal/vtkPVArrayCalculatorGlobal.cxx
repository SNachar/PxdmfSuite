...
=========================================================================*/
#include "vtkPVArrayCalculatorGlobal.h"
...
namespace
{
  ...
  class add_scalar_variables
    {
    vtkPVArrayCalculatorGlobal* Calc;
    const char* ArrayName;
    int Component;
  public:
    add_scalar_variables(vtkPVArrayCalculatorGlobal* calc,
...
vtkStandardNewMacro( vtkPVArrayCalculatorGlobal );
// ----------------------------------------------------------------------------
vtkPVArrayCalculatorGlobal::vtkPVArrayCalculatorGlobal()
{
}
...
// ----------------------------------------------------------------------------
void vtkPVArrayCalculatorGlobal::UpdateArrayAndVariableNames
...
{ 
  ...
  for (int j = 0; j < numberArays; j ++ )
    ...
    if (
      //array->GetDataType() == VTK_STRING
       array->IsA("vtkStringArray") 
        || array->GetDataType() == VTK_VARIANT  )
      {
      continue;
      }
...
// ----------------------------------------------------------------------------
int vtkPVArrayCalculatorGlobal::RequestData
...
// ----------------------------------------------------------------------------
void vtkPVArrayCalculatorGlobal::PrintSelf( ostream & os, vtkIndent indent )
{
