...
public:
    ...
    //
    static int GUIMaxNbModes;   // maximal number of mode showed int the GUI.
//----------------------------------------------------------------------------- 
    // Description:
...
//ETX
    ...
    const char* GetVisualizationSpaceArrayName(int index);   // Returns the name of point array at the give index. Returns NULL if index is invalid.
...
//-----------------------------------------------------------------------------
    void SetPointArrayStatus(const char* arrayBaseName,const int& arrayMode,const  int& status);
    void SetCellArrayStatus(const char* arrayBaseName,const int& arrayMode,const  int& status);
...
private:
    ...
    virtual vtkXdmfDomain* PrepareDocument();

    
    vtkXdmfDomain * LastTimeDomainReader;
//BTX
