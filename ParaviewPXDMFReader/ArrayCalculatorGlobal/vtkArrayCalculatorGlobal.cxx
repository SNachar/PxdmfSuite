/*=========================================================================
  ...
  Module:    vtkArrayCalculatorGlobal.cxx
...
vtkStandardNewMacro(vtkArrayCalculatorGlobal);

vtkArrayCalculatorGlobal::vtkArrayCalculatorGlobal()
{
  this->FunctionParser = vtkFunctionParser::New();                      // delete ok
  this->Function = NULL;
...
void vtkArrayCalculatorGlobal::SetResultArrayName(const char* name)
{
  if (name == NULL || *name == '\0')
    {
...
int vtkArrayCalculatorGlobal::RequestData(
...
void vtkArrayCalculatorGlobal::SetFunction(const char* function)
{
...
void vtkArrayCalculatorGlobal::AddScalarArrayName(const char* arrayName,
                                            int component)
{
  if (!arrayName)
    {
...
void vtkArrayCalculatorGlobal::AddVectorArrayName(const char* arrayName,
...
void vtkArrayCalculatorGlobal::AddScalarVariable(const char* variableName,
...
void vtkArrayCalculatorGlobal::AddVectorVariable(const char* variableName,
                                           const char* arrayName,
                                           int component0, int component1,
                                           int component2)
{
...
void vtkArrayCalculatorGlobal::AddCoordinateScalarVariable(const char* variableName,
                                                     int component)
{
  int i;
...
void vtkArrayCalculatorGlobal::AddCoordinateVectorVariable(const char* variableName,
                                                     int component0, 
                                                     int component1, 
                                                     int component2)
{
...
const char* vtkArrayCalculatorGlobal::GetAttributeModeAsString()
{
  if ( this->AttributeMode == VTK_ATTRIBUTE_MODE_DEFAULT )
    {
    return "Default";
...
void vtkArrayCalculatorGlobal::RemoveScalarVariables()
{
  int i;
...
void vtkArrayCalculatorGlobal::RemoveVectorVariables()
{
  int i;
...
void vtkArrayCalculatorGlobal::RemoveCoordinateScalarVariables()
{
  int i;
...
void vtkArrayCalculatorGlobal::RemoveCoordinateVectorVariables()
{
  int i;
...
void vtkArrayCalculatorGlobal::RemoveAllVariables()
{
...
char* vtkArrayCalculatorGlobal::GetScalarArrayName(int i)
{
...
char* vtkArrayCalculatorGlobal::GetVectorArrayName(int i)
{
...
char* vtkArrayCalculatorGlobal::GetScalarVariableName(int i)
{
  if (i < this->NumberOfScalarArrays)
    {
...
char* vtkArrayCalculatorGlobal::GetVectorVariableName(int i)
{
  if (i < this->NumberOfVectorArrays)
    {
...
int vtkArrayCalculatorGlobal::GetSelectedScalarComponent(int i)
{
  if (i < this->NumberOfScalarArrays)
    {
...
int* vtkArrayCalculatorGlobal::GetSelectedVectorComponents(int i)
{
  if (i < this->NumberOfVectorArrays)
    {
...
void vtkArrayCalculatorGlobal::PrintSelf(ostream& os, vtkIndent indent)
{
